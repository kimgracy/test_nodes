...
class YoloDetector(Node):
    ...
    def __init__(self):
        ...
        # create subscribers
        self.subscriber_phase = self.create_subscription(VehiclePhase, '/vehicle_phase', self.vehicle_phase_publisher_callback, qos_profile)
    ...
    def main_timer_callback(self):
        if self.phase == 0:
            ...
            self.publish_gimbal_control(pitch = float(0))
            print(self.phase)
